...
class CreateRugbyTeam extends StatefulWidget {
  const CreateRugbyTeam({Key? key}) : super(key: key);

  @override
  State<CreateRugbyTeam> createState() => _CreateRugbyTeamState();
}

class _CreateRugbyTeamState extends State<CreateRugbyTeam> {
                      ...
                      child: elevatedButton(
                          onpress: () async {
                            ...
                            await dataController
                              ...
                              resetControllers();
                              UserHelper.createMembersSubCollection(dataController.myDocument!.id, dataController.myDocument!.get('firstname'),dataController.myDocument!.get('fcmToken'),dataController.myDocument!.get('profilePicture'),teamName.text,'Rugby');
                            });
                          },
                          text: 'Create Team'),
                    )),
