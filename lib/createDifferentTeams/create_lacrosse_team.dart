...
class CreateLacrosseTeam extends StatefulWidget {
  const CreateLacrosseTeam({Key? key}) : super(key: key);

  @override
  State<CreateLacrosseTeam> createState() => _CreateLacrosseTeamState();
}

class _CreateLacrosseTeamState extends State<CreateLacrosseTeam> {
                      ...
                      child: elevatedButton(
                          onpress: () async {
                            ...
                            await dataController
                              ...
                              resetControllers();
                              UserHelper.createMembersSubCollection(dataController.myDocument!.id, dataController.myDocument!.get('firstname'),dataController.myDocument!.get('fcmToken'),dataController.myDocument!.get('profilePicture'),teamName.text,'Lacrosse');
                            });
                          },
                          text: 'Create Team'),
                    )),
