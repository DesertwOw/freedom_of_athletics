...
class CreateVolleyballTeam extends StatefulWidget {
  const CreateVolleyballTeam({Key? key}) : super(key: key);

  @override
  State<CreateVolleyballTeam> createState() => _CreateVolleyballTeamState();
}

class _CreateVolleyballTeamState extends State<CreateVolleyballTeam> {
                      ...
                      child: elevatedButton(
                          onpress: () async {
                            ...
                            await dataController
                              ...
                              resetControllers();
                              UserHelper.createMembersSubCollection(dataController.myDocument!.id, dataController.myDocument!.get('firstname'),dataController.myDocument!.get('fcmToken'),dataController.myDocument!.get('profilePicture'),teamName.text,'Volleyball');
                            });
                          },
                          text: 'Create Team'),
                    )),
