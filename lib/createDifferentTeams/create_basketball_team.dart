...
class CreateBasketballTeam extends StatefulWidget {
  const CreateBasketballTeam({Key? key}) : super(key: key);

  @override
  State<CreateBasketballTeam> createState() => _CreateBasketballTeamState();
}

class _CreateBasketballTeamState extends State<CreateBasketballTeam> {
                        ...
                        child: elevatedButton(
                            onpress: () async {
                              ...
                              await dataController
                                ...
                                resetControllers();
                                UserHelper.createMembersSubCollection(dataController.myDocument!.id, dataController.myDocument!.get('firstname'),dataController.myDocument!.get('fcmToken'),dataController.myDocument!.get('profilePicture'),teamName.text,'Basketball');
                              });
                            },
                            text: 'Create Team'),
                      )),
