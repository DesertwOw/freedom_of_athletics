...
class CreateHandballTeam extends StatefulWidget {
  const CreateHandballTeam({Key? key}) : super(key: key);

  @override
  State<CreateHandballTeam> createState() => _CreateHandballTeamState();
}

class _CreateHandballTeamState extends State<CreateHandballTeam> {
                      ...
                      child: elevatedButton(
                          onpress: () async {
                            ...
                            await dataController
                              ...
                              resetControllers();
                              UserHelper.createMembersSubCollection(dataController.myDocument!.id, dataController.myDocument!.get('firstname'),dataController.myDocument!.get('fcmToken'),dataController.myDocument!.get('profilePicture'),teamName.text,'Handball');
                            });
                          },
                          text: 'Create Team'),
                    )),
