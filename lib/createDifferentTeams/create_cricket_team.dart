...
class CreateCricketTeam extends StatefulWidget {
  const CreateCricketTeam({Key? key}) : super(key: key);

  @override
  State<CreateCricketTeam> createState() => _CreateCricketTeamState();
}

class _CreateCricketTeamState extends State<CreateCricketTeam> {
                      ...
                      child: elevatedButton(
                          onpress: () async {
                            ...
                            await dataController
                              ...
                              resetControllers();
                              UserHelper.createMembersSubCollection(dataController.myDocument!.id, dataController.myDocument!.get('firstname'),dataController.myDocument!.get('fcmToken'),dataController.myDocument!.get('profilePicture'),teamName.text,'Cricket');
                            });
                          },
                          text: 'Create Team'),
                    )),
