...
class CreateFootbalTeam extends StatefulWidget {
  const CreateFootbalTeam({Key? key}) : super(key: key);

  @override
  State<CreateFootbalTeam> createState() => _CreateFootbalTeamState();
}

class _CreateFootbalTeamState extends State<CreateFootbalTeam> {
                      ...
                      child: elevatedButton(
                          onpress: () async {
                            ...
                            await dataController
                              ...
                              resetControllers();
                              UserHelper.createMembersSubCollection(dataController.myDocument!.id, dataController.myDocument!.get('firstname'),dataController.myDocument!.get('fcmToken'),dataController.myDocument!.get('profilePicture'),teamName.text,'Football');
                            });
                          },
                          text: 'Create Team'),
                    )),
