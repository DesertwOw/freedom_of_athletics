...
import '../widgets/teamWidgets/team_badge_widget.dart';

class CreateIceHockeyTeam extends StatefulWidget {
  const CreateIceHockeyTeam({Key? key}) : super(key: key);

  @override
  State<CreateIceHockeyTeam> createState() => _CreateIceHockeyTeamState();
}

class _CreateIceHockeyTeamState extends State<CreateIceHockeyTeam> {
                      ...
                      child: elevatedButton(
                          onpress: () async {
                            ...
                            await dataController
                              ...
                              resetControllers();
                              UserHelper.createMembersSubCollection(dataController.myDocument!.id, dataController.myDocument!.get('firstname'),dataController.myDocument!.get('fcmToken'),dataController.myDocument!.get('profilePicture'),teamName.text,'Ice-Hockey');
                            });
                          },
                          text: 'Create Team'),
                    )),
