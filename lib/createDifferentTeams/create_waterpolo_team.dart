...
class CreateWaterpoloTeam extends StatefulWidget {
  const CreateWaterpoloTeam({Key? key}) : super(key: key);

  @override
  State<CreateWaterpoloTeam> createState() => _CreateWaterpoloTeamState();
}

class _CreateWaterpoloTeamState extends State<CreateWaterpoloTeam> {
                      ...
                      child: elevatedButton(
                          onpress: () async {
                            ...
                            await dataController
                              ...
                              resetControllers();
                              UserHelper.createMembersSubCollection(dataController.myDocument!.id, dataController.myDocument!.get('firstname'),dataController.myDocument!.get('fcmToken'),dataController.myDocument!.get('profilePicture'),teamName.text,'Waterpolo');
                            });
                          },
                          text: 'Create Team'),
                    )),
